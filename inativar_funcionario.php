...
<head>
    ...
    <title>Inativar Funcionário</title>
            ...
            if ($result->num_rows > 0) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if ($stmt->affected_rows > 0) {
                        echo '<div class="alert alert-success" role="alert">Funcionário inativado com sucesso!</div>';
                    } else {
                        echo '<div class="alert alert-danger" role="alert">Erro ao inativar o funcionário. Por favor, tente novamente.</div>';
                    }
        ...
        ?>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $funcionarioId; ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="cargo" name="cargo" value="<?php echo $cargo; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="departamento">Departamento:</label>
                        <input type="text" class="form-control" id="departamento" name="departamento" value="<?php echo $departamento; ?>" readonly>
                    </div>
