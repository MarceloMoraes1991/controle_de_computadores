<?php
    ...
    if (isset($_GET['id'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE atividades_arquivadas SET titulo = '$titulo', aberto_por = '$abertoPor', observacao = '$observacao', fomentar = '$fomentar' WHERE id = $id";
            $result = mysqli_query($con, $sql);
...
<body>
    ...
    <div class="container">
        ...
        <form action="editar_atividade.php?id=<?= $id ?>" method="post">
            ...
            <div class="button-container">
                ...
                <a href="atividades_arquivadas.php" class="btn waves-effect waves-light">Voltar</a>
            </div>
        </form>
    </div>
</body>
